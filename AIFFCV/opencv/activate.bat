...
:: =====================================================================
::  Purpose:
::    Configures the MSVC toolchain environment for the OpenCV
...
set "CV_PREFIX=%~dp0"
if "%CV_PREFIX:~-1%/"=="\/" set "CV_PREFIX=%CV_PREFIX:~0,-1%"

:: --- CONFIG ---

set "_LIBRARY=OpenCV"
set "_BINPATH=%CV_PREFIX%\build\x64\vc15\bin"
set "_BINNAME=opencv_world460.dll"
set "_INCPATH=%CV_PREFIX%\build\include"
set "_INCNAME=opencv.hpp"
set "_INCEXT=\opencv2"
set "_LIBPATH=%CV_PREFIX%\build\x64\vc15\lib"
