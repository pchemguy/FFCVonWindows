...
:: =====================================================================
::  Purpose:
::    Configures the MSVC toolchain environment for the LibJPEG-Turbo
...
:: set "LJT_PREFIX=%~dp0"
:: if "%LJT_PREFIX:~-1%/"=="\/" set "LJT_PREFIX=%LJT_PREFIX:~0,-1%"

:: --- CONFIG ---

set "_LIBRARY=LibJPEG-Turbo"
set "LJT_PREFIX=%__CONDA_PREFIX%\Library"
set "_BINPATH=%LJT_PREFIX%\bin"
set "_BINNAME=turbojpeg.dll"
set "_INCPATH=%LJT_PREFIX%\include"
set "_INCNAME=turbojpeg.h"
set "_INCEXT="
set "_LIBPATH=%LJT_PREFIX%\lib"
